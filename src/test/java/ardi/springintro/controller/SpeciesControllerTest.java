    ...
    static void beforeAll() throws Exception{
        ...
        mockWebServer.setDispatcher(new Dispatcher() {
            ...
            public MockResponse dispatch(RecordedRequest recordedRequest) throws InterruptedException {
                ...
                String jsonFilePath = "";
                if (recordedRequest.getPath().equals("/species")) {
                    jsonFilePath = "src/test/resources/jsonResponse/SpeciessResponse.json";
                }
                else {
                    jsonFilePath = "src/test/resources/jsonResponse/SpeciesResponse.json";
                }
